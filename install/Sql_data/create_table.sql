...
CREATE TABLE IF NOT EXISTS `ftxia_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ftxia_plugin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='插件列表' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `ftxia_robots_uz` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) NOT NULL,
