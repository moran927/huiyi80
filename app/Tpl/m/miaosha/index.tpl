...
<div id="wrapper">
 <div class="scroller">
 <hgroup class="breadcrumb"><span><a href="{:C('ftx_headerm_html')}">返回</a></span>天天秒杀</hgroup>
  <section class="startTime" ><aside class="time">每天 10:00 开抢</aside></section>
<div class="item">
...
<!--底部结束-->
  ...
  var FTXIA = {
    ...
    'ajax':"{:U('miaosha/index',array('sort'=>$cur))}",
  };
</script>
</html>
