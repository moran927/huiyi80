...
<div id="wrapper">
 <div class="scroller">
 <hgroup class="breadcrumb"><span><a href="{:C('ftx_headerm_html')}">返回</a></span>精品预告</hgroup>
 <section class="startTime"><aside class="time"><script language="JavaScript" type="text/javascript">    
...
<!--底部结束-->
  ...
  var FTXIA = {
    ...
    'ajax':"{:U('yugao/index',array('sort'=>$cur))}",
  };
</script>
</html>
