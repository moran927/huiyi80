...
<div id="wrapper">
 <div class="scroller">
    <header>
         <hgroup class="breadcrumb"><span><a href="{:C('ftx_headerm_html')}">返回</a></span>9.9包邮</hgroup>
    </header>
<div class="item">
...
<!--分类导航开始-->
<nav class="tag">
   <a href="{:U('jiu/jiu')}" class="cur"><span>9.9</span></a>
  
  <a href="{:U('jiu/shijiu')}"><span>19.9</span></a>
  <a href="{:U('jiu/erjiu')}" ><span>29.9</span></a>
</nav>
<!--分类导航结束-->
<!--排序开始-->
