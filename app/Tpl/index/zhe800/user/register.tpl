...
<link rel=stylesheet type=text/css href="__STATIC__/red/css/login.css" />
...
<div class="login-main">
		...
		<div class="top">
			<div class="logo_show"><a href="{:C('ftx_site_url')}" title="{:C('ftx_site_name')}" class="zhe800"><img src="{:C('ftx_site_url')}/{:C('ftx_site_logo')}" width="240" height="45" /></a></div>
		</div>
					...
					<ul>
					 <li>
							<div class="user">
								...
								<input name="qq" type="text" id="qq" placeholder="QQ号码" onkeyup="value=value.replace(/[^\d]/g,'')" value="" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" onblur="var qq=$(this).val();if(qq=='') return false;qq=qq+'@qq.com';if($('#emailMatch').val()==''){$('#emailMatch').val(qq)}" maxlength="11" class="user-input" autocomplete="off"/>
								</div>
							<div class="error-box">
						...
						<li>
							<div class="user">
								<span><i class="pass-ico"></i></span>
								<input class="user-input" type="password" placeholder="请再次输入密码" name="repassword" value="" autocomplete="off"/>
							</div>
						...
						<li style="padding-bottom:0">
							<div class="chex">
								<span><label><input class="ck" name="agreement" type="checkbox" checked="checked"/>{:L('i_agree')}《<a href="javascript:;" id="J_protocol_btn">{:C('ftx_site_name')}{:L('user_protocol')}</a>》</label></span>
							</div>
						</li>
		...
		<p><a href="http://www.miibeian.gov.cn/" rel="nofollow" target="_blank">{:C('ftx_site_icp')}</a> Copyright © 2010-2014 138gzs.com V6.0 正式版 all Rights Reserved <a href="http://www.138gzs.com/" target="_blank">华美网络</a>
