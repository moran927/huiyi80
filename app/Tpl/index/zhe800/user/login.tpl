...
<div class="login-main">
		...
		<div class="user-login">
			<div class="login-top">
				...
				<span class="login-r"><a class="active" href="{:C('ftx_site_url')}">返回首页>></a></span>
						...
						<p class="zhuce">还没有帐号，<a class="blu" href="{:U('user/register')}">立即注册</a></p>
					</div>
		...
		<p><a href="http://www.miibeian.gov.cn/" rel="nofollow" target="_blank">{:C('ftx_site_icp')}</a> Copyright © 2010-2014 138GZS.com V5.0 正式版 all Rights Reserved <a href="http://bbs.138gzs.com/" target="_blank">华美网络飞天侠</a>
