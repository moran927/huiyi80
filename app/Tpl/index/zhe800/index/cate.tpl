...
<div class="dir">
    ...
    <div class="tag_nav_shopping col-{$bcates.zm}">
	    ...
	    <a href="{:U('index/cate',array('cid'=>$motherid))}" class="cur">所有</a>
	     ...
	     <if condition="$bcates['name'] eq '身材' or $bcates['name'] eq '材质' or $bcates['name'] eq '跟型'">
	      
             <volist name="bcates.child" id="bcatew">
             <if condition="$bcatew['id'] eq $scid">
	     <li><a href="{:U('index/cate',array('scid'=>$bcatew['id'],'cid'=>$cid,'fgid'=>$fgid,'lxid'=>$lxid))}" class="cur"><strong>{$bcatew.name}</strong></a></li>
	     <else />
	     <li><a href="{:U('index/cate',array('scid'=>$bcatew['id'],'cid'=>$cid,'fgid'=>$fgid,'lxid'=>$lxid))}"><strong>{$bcatew.name}</strong></a></li>
	     </if>
              </volist>
	      <elseif condition="$bcates['name'] eq '风格'" />
	     <volist name="bcates.child" id="bcatew">
             <if condition="$bcatew['id'] eq $fgid">
	     <li><a href="{:U('index/cate',array('fgid'=>$bcatew['id'],'cid'=>$cid,'scid'=>$scid,'lxid'=>$lxid))}" class="cur"><strong>{$bcatew.name}</strong></a></li>
	     <else />
	     <li><a href="{:U('index/cate',array('fgid'=>$bcatew['id'],'cid'=>$cid,'scid'=>$scid,'lxid'=>$lxid))}"><strong>{$bcatew.name}</strong></a></li>
	     </if>
              </volist>
	      <elseif condition="$bcates['name'] eq '流行'" />
               <volist name="bcates.child" id="bcatew">
             <if condition="$bcatew['id'] eq $lxid">
	     <li><a href="{:U('index/cate',array('lxid'=>$bcatew['id'],'cid'=>$cid,'scid'=>$scid,'fgid'=>$fgid))}" class="cur"><strong>{$bcatew.name}</strong></a></li>
	     <else />
	     <li><a href="{:U('index/cate',array('lxid'=>$bcatew['id'],'cid'=>$cid,'scid'=>$scid,'fgid'=>$fgid))}"><strong>{$bcatew.name}</strong></a></li>
	     </if>
              </volist>
	      <else />
              <volist name="bcates.child" id="bcatew">
             <if condition="$bcatew['id'] eq $cid">
	     <li><a href="{:U('index/cate',array('cid'=>$bcatew['id'],'lxid'=>$lxid,'scid'=>$scid,'fgid'=>$fgid))}" class="cur"><strong>{$bcatew.name}</strong></a></li>
	     <else />
	     <li><a href="{:U('index/cate',array('cid'=>$bcatew['id'],'lxid'=>$lxid,'scid'=>$scid,'fgid'=>$fgid))}"><strong>{$bcatew.name}</strong></a></li>
	     </if>
              </volist>
	      </if>
