...
<div class="jiu-nav-main">
	<div class="jiu-nav {:C('ftx_site_width')}">
		...
		<div class="nav-item fl">
			<div class="item-list">
				<ul>
				<li><a href="{:U('shijiu/index')}" <if condition="$nav_curr eq shijiu">class="active"</if>>全部</a></li>
				
				<volist name="tag_list" id="bcate">
					
					<li><a <if condition="$tag eq $bcate['id']">class="active"</if> href="{:U('shijiu/index',array('tag'=>$bcate['id']))}" title="{$bcate.name}">{$bcate.name}</a></li>	
					</if>
				</volist>
				</ul>
			</div>
		...
		<div class="n_h">
			<span>排序：</span>
			<a href="{:U('shijiu/index',array('sort'=>'default'))}"  class=" <if condition="$index_info['sort'] eq 'default'"> active </if> ">默认</a>
			<a href="{:U('shijiu/index',array('sort'=>'new'))}" class=" <if condition="$index_info['sort'] eq 'new'"> active </if> ">最新</a>
			<a href="{:U('shijiu/index',array('sort'=>'hot'))}" class=" <if condition="$index_info['sort'] eq 'hot'"> active </if> ">最热</a></div>
		</div>
	</div>
</div>
