		...
		<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
			<tr>
				...
				<td><input type="text" name="nick" id="nick" class="input-text" size="20" value="{$info.nick}"></td>
                        ...
                        <tr>
				<th width="120">所属分类-身材 :</th>
				<td><select class="J_cate_selectsc mr10" data-pid="0" data-uri="{:U('items_cate/ajax_getchilds', array('type'=>0))}" data-selected="{$selected_idssc}"></select>
				<input type="hidden" name="cate_idsc" id="J_cate_idsc" value="{$info.cate_idsc}" /></td>
				
			</tr>
			<tr>
				<th width="120">所属分类-风格 :</th>
				<td><select class="J_cate_selectfg mr10" data-pid="0" data-uri="{:U('items_cate/ajax_getchilds', array('type'=>0))}" data-selected="{$selected_idsfg}"></select>
				<input type="hidden" name="cate_idfg" id="J_cate_idfg" value="{$info.cate_idfg}" /></td>
				
			</tr>
			<tr>
				<th width="120">所属分类-流行 :</th>
				<td><select class="J_cate_selectlx mr10" data-pid="0" data-uri="{:U('items_cate/ajax_getchilds', array('type'=>0))}" data-selected="{$selected_idslx}"></select>
				<input type="hidden" name="cate_idlx" id="J_cate_idlx" value="{$info.cate_idlx}" /></td>
...
$('.J_cate_selectsc').cate_selectsc('请选择');
$('.J_cate_selectfg').cate_selectfg('请选择');
$('.J_cate_selectlx').cate_selectlx('请选择');
