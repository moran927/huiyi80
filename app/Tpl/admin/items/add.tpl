	...
	<div class="col_tab">
		...
		<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
			...
			<tr>
				...
				<td><select class="J_cate_selectsc mr10" data-pid="0" data-uri="{:U('items_cate/ajax_getchilds', array('type'=>0))}" data-selected=""></select><input type="hidden" name="cate_idsc" id="J_cate_idsc" value="" /></td>
			</tr>

			<tr>
				<th width="120">所属分类--风格 :</th>
				<td><select class="J_cate_selectfg mr10" data-pid="0" data-uri="{:U('items_cate/ajax_getchilds', array('type'=>0))}" data-selected=""></select><input type="hidden" name="cate_idfg" id="J_cate_idfg" value="" /></td>
				
			</tr>

			<tr>
				<th width="120">所属分类--流行 :</th>
				<td><select class="J_cate_selectlx mr10" data-pid="0" data-uri="{:U('items_cate/ajax_getchilds', array('type'=>0))}" data-selected=""></select><input type="hidden" name="cate_idlx" id="J_cate_idlx" value="" /></td>
