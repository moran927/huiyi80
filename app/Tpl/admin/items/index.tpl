...
<div class="pad_lr_10" >
    ...
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
		    ...
		    <if condition="$val.shop_type eq 'B' ">
		    <a href="http://detail.tmall.com/item.htm?id={$val.num_iid}" target="_blank">
		    <else />
		     <a href="http://item.taobao.com/item.htm?id={$val.num_iid}" target="_blank">
		    </if>
		    <img src="{:attach(get_thumb($val['pic_url'], '_s'), 'item')}" width="100" width="100" class="J_preview" data-bimg="{:attach(get_thumb($val['pic_url'],'_m'), 'item')}"></a></div>
                </td>
