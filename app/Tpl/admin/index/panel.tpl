...
<div class="pad_10">
	<div class="clearfix">
		...
		<div class="col-2 fl mr10" style="width:48%">
			<h6>系统信息</h6>
			<div class="content">
				{:L('ftxia_version')}：<font style="color:#090">HuaMei {$system_info.ftxia_version}</font> 最新版本<span style="color: #260BEE;font-weight: bold;" id="new_version">6.0</span><span id="version_update">[在线升级]</span><br />
