...
class cmt_taobaoAction extends BackendAction {
    ...
    private function _collect_one($iid, $item_id) {
        ...
        if ($seller['type'] == 'tmall') {
			...
			//http://rate.taobao.com/feedRateList.htm?userNumId=1649937960&auctionNumId=41039693103&currentPageNum=1
    ...
    private function _collect_ones($iid, $item_id,$p =1) {
        ...
        if ($seller['type'] == 'tmall') {
            $rate_tmall_api = 'http://rate.tmall.com/list_detail_rate.htm?itemId='.$iid.'&spuId=&sellerId='.$seller['id'].'&order=0&forShop=1&append=0&currentPage='.$p;
//http://rate.tmall.com/list_detail_rate.htm?itemId=22577343652&spuId=231846687&sellerId=1783914029&order=1&currentPage=2&append=0&content=1&tagId=&posi=&picture=&ua=255fCJmZk4PGRVHHxtOZXEsYX41YiR%2FN2EaIA%3D%3D%7CfyJ6ZyByNmYmZ3UnZHQraBk%3D%7CfiB4D157YHtufDUqfHY4f2IzfCwSCxFTW1gNQ2ob%7CeSRiYjNhJ385dGIwcGM4emUheDp9OXlrOXVhNXZvK302aSBiZlw%3D%7CeCVoaEARTxdWFR9NFRETRx5cWgo%2BEw%3D%3D%7CeyR8C0EXSRBMCRxPAghTEQxMA0AaXB4URAYYWB0CRxJMElAcZ10%3D%7CeiJ6DVxcQUZCUxsIXlQKS0sJXhhGGlxKFVUuHw%3D%3D%7CdS11AlMSTBNTERtNDRlCGgRCFFRgTQ%3D%3D%7CdCx0A1ITTRNWERtPCh5HHwVOGFhsQQ%3D%3D%7Cdy93AFEQThJWFR9LDhBMFAFDF1ZiTw%3D%3D%7Cdi52AVARTx5aFx1JDBtHHwJAE1cPIgs%3D%7CcShwB1YXSXszcmQvaH8jb28kdDVyN294KWhiPX5%2BPmRLDk4WElcPGEUFH1VrRA%3D%3D%7CcChscC98InklYHIkfGkwc3M0ezhhPXB6JX1sLG5uLHtU&_ksTS=1416905469255_1341&callback=jsonp1342
           $source = Http::fsockopenDownload($rate_tmall_api);
			if(!$source){
